...
snapshot_tests![
    ...
    invalid_call_object_not_a_function,
    invalid_call_to_non_function_identifier,
    invalid_call_to_undeclared_function,
    ...
    invalid_redeclared_function_with_different_type,
    invalid_redeclared_function_as_variable,
    invalid_redeclared_function_as_typedef,
    invalid_redeclared_local_variables,
    invalid_redefine,
    ...
    invalid_type,
    invalid_typedef_redeclared_as_function,
    invalid_typedef_redeclared_as_variable,
...
snapshot_tests![
    ...
    valid_redeclared_function,
    valid_redeclared_global_variables,
    valid_redeclared_typedef,
